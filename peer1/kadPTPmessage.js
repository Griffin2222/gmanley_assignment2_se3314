  ...
  init: function (ver, msgType, peerTable) {
    ...
    if (noOfPeers > 0) {
      ...
      for (var k = 0; k < noOfPeers; k++) {
        //console.log("Checking peerTable.table at index:", k);
        //console.log("peerTable.table length:", peerTable.table.length);
        if (peerTable.table[k] && peerTable.table[k].node) {
          ...
          //console.log("Error: Missing node information in peerTable.table at index " + k);
        }
      }
    }
